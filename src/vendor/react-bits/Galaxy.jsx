  ...
  useEffect(() => {
    ...
    function update(t) {
      if (!pausedRef.current) {
        ...
        elapsed += Math.min(50, Math.max(0, t - lastTime));
      }
      lastTime = t;
      if (!disableAnimation) {
    ...
    playbackRef.current = () => { cancelAnimationFrame(animateId); lastTime = performance.now(); update(lastTime); };
    playbackRef.current();
